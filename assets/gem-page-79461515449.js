...
jQuery(function () {
  var $hero = jQuery('#m-1617045987736');
  var $module = jQuery('#m-1617045987736').children('.module');
  ...
  if ($module.attr('data-fixedMode') == '1') {
    ...
    $module.parent().removeClass('gf_hero-fixed-mode');
      ...
      jQuery(function() {
  var $module = jQuery('#m-1617045987711').children('.module');
  $module.gfV3Product();
});
          jQuery(function() {
    var $module = jQuery('#m-1617045987838').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
      ...
      jQuery(function() {
        var $module = jQuery('#m-1617045987711-2').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });jQuery(function() {
  var $module = jQuery('#m-1617045987711-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
});
      jQuery(function() {
  var $module = jQuery('#m-1617045987727').children('.module');
  $module.gfV3Product();
});
          jQuery(function() {
    var $module = jQuery('#m-1617045987783').children('.module');
    var effect = $module.attr('data-effect');
    $module.gfV3ProductImage({
        'effect': effect
    })
      ...
      jQuery(function() {
        var $module = jQuery('#m-1617045987727-2').children('.module');
        $module.gfV3ProductPrice({
            displayCurrency: true
        });
    });jQuery(function() {
  var $module = jQuery('#m-1617045987727-3').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
});
